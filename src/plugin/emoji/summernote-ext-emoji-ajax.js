    ...
    $.extend($.summernote.plugins, {
        ...
        'emoji' :function (context) {
                    ...
                    children :[
                        ...
                        ui.dropdown({
                            ...
                            items :[
                                ...
                                '  </div>',
                                '  <table class="note-emoji-menu-tabs">',
                                '      <tbody>',
                                '          <tr>',
                                '              <td title="all" class="note-emoji-all note-emoji-tabs-btn selected-emoji-type"><div>all</div></td>',
                                '              <td title="people" class="note-emoji-people note-emoji-tabs-btn"><img src="https://github.githubassets.com/images/icons/emoji/unicode/1f603.png?v8" /></td>',
                                '              <td title="nature" class="note-emoji-nature note-emoji-tabs-btn"><img src="https://github.githubassets.com/images/icons/emoji/unicode/1f41c.png?v8" /></td>',
                                '              <td title="objects" class="note-emoji-objects note-emoji-tabs-btn"><img src="https://github.githubassets.com/images/icons/emoji/unicode/1f3b1.png?v8" /></td>',
                                '              <td title="places" class="note-emoji-places note-emoji-tabs-btn"><img src="https://github.githubassets.com/images/icons/emoji/unicode/1f6a1.png?v8" /></td>',
                                '              <td title="symbols" class="note-emoji-symbols note-emoji-tabs-btn"><img src="https://github.githubassets.com/images/icons/emoji/unicode/1f4af.png?v8" /></td>',
                                '          </tr>',
                                '      </tbody>',
                                '  </table>',
                            ...
                            callback :function ($dropdown) {
                                ...
                                $dropdown.on('click', '.note-emoji-menu-tabs', function (e) { e.stopPropagation() })
                                $.each($dropdown.find('.note-emoji-tabs-btn'), function (index, el) {
                                    var type = el.classList[0].slice(11,)
                                    $dropdown.on('click', `.note-emoji-${type}`, function (e) {
                                        self.$tabs.find(`.note-emoji-${type}`).toggleClass('selected-emoji-type', true)
                                        self.$tabs.find('.note-emoji-tabs-btn').not(`.note-emoji-${type}`).toggleClass('selected-emoji-type', false)
                                        if (type == 'all') {
                                            self.$list.find(`.note-emoji-btn`).show()
                                        }
                                        else {
                                            self.$list.find(`.emoji-${type}`).show()
                                            var other_type = self.$list.find('.note-emoji-btn').not(`.emoji-${type}`)
                                            other_type.hide()
                                        }
                                    })
                                })
            ...
            self.filter_type = function (name) {
                ...
                const Symbols = ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "keycap_ten", "1234", "zero", "hash", "symbols", "arrow_backward", "arrow_down", "arrow_forward", "arrow_left", "capital_abcd", "abcd", "abc", "arrow_lower_left", "arrow_lower_right", "arrow_right", "arrow_up", "arrow_upper_left", "arrow_upper_right", "arrow_double_down", "arrow_double_up", "arrow_down_small", "arrow_heading_down", "arrow_heading_up", "leftwards_arrow_with_hook", "arrow_right_hook", "left_right_arrow", "arrow_up_down", "arrow_up_small", "arrows_clockwise", "arrows_counterclockwise", "rewind", "fast_forward", "information_source", "ok", "twisted_rightwards_arrows", "repeat", "repeat_one", "new", "top", "up", "cool", "free", "ng", "cinema", "koko", "signal_strength", "u5272", "u5408", "u55b6", "u6307", "u6708", "u6709", "u6e80", "u7121", "u7533", "u7a7a", "u7981", "sa", "restroom", "mens", "womens", "baby_symbol", "no_smoking", "parking", "wheelchair", "metro", "baggage_claim", "accept", "wc", "potable_water", "put_litter_in_its_place", "secret", "congratulations", "m", "passport_control", "left_luggage", "customs", "ideograph_advantage", "cl", "sos", "id", "no_entry_sign", "underage", "no_mobile_phones", "do_not_litter", "non-potable_water", "no_bicycles", "no_pedestrians", "children_crossing", "no_entry", "eight_spoked_asterisk", "sparkle", "eight_pointed_black_star", "heart_decoration", "vs", "vibration_mode", "mobile_phone_off", "chart", "currency_exchange", "aries", "taurus", "gemini", "cancer", "leo", "virgo", "libra", "scorpius", "sagittarius", "capricorn", "aquarius", "pisces", "ophiuchus", "six_pointed_star", "negative_squared_cross_mark", "a", "b", "ab", "o2", "diamond_shape_with_a_dot_inside", "recycle", "end", "back", "on", "soon", "clock1", "clock130", "clock10", "clock1030", "clock11", "clock1130", "clock12", "clock1230", "clock2", "clock230", "clock3", "clock330", "clock4", "clock430", "clock5", "clock530", "clock6", "clock630", "clock7", "clock730", "clock8", "clock830", "clock9", "clock930", "heavy_dollar_sign", "copyright", "registered", "tm", "x", "heavy_exclamation_mark", "bangbang", "interrobang", "o", "heavy_multiplication_x", "heavy_plus_sign", "heavy_minus_sign", "heavy_division_sign", "white_flower", "100", "heavy_check_mark", "ballot_box_with_check", "radio_button", "link", "curly_loop", "wavy_dash", "part_alternation_mark", "trident", "black_small_square", "white_small_square", "black_medium_small_square", "white_medium_small_square", "black_medium_square", "white_medium_square", "black_large_square", "white_large_square", "white_check_mark", "black_square_button", "white_square_button", "black_circle", "white_circle", "red_circle", "large_blue_circle", "large_blue_diamond", "large_orange_diamond", "small_blue_diamond", "small_orange_diamond", "small_red_triangle", "small_red_triangle_down", "shipit"]

                if (People.includes(name)) return 'emoji-people'
                else if (Nature.includes(name)) return 'emoji-nature'
                else if (Objects.includes(name)) return 'emoji-objects'
                else if (Places.includes(name)) return 'emoji-places'
                else if (Symbols.includes(name)) return 'emoji-symbols'
                // else return 'emoji-others'
            }
